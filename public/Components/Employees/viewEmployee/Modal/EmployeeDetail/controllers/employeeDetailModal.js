hrms_app.controller("employeeDetailModalCtrl", ['$scope', '$uibModal', '$log','employeeSvc','attendanceSvc','settingsSvc', function ($scope, $uibModal, $log,employeeSvc,attendanceSvc,settingsSvc) {

    $scope.showEmployeeDetails = function (employee) {
        console.log("Show Form Button Clicked");
        
        var modalInstance = $uibModal.open({
            templateUrl: 'Components/Employees/viewEmployee/Modal/EmployeeDetail/employeeDetail.html',
            controller: EmployeeInstanceCtrl,
            scope: $scope,
            resolve: {
                employee: function () {
                  return employee;
...
let EmployeeInstanceCtrl = function ($scope, $uibModalInstance,$timeout,employee,attendanceData,settingsData) {
    console.log("inside employee modal ctrl")
